...
class ServiceTemplate:
    ...
    def get_python_modules(self):
        modules = [microskel.log_call_module, microskel.hello_module, 
                   microskel.consul_module,
                    microskel.health_module, microskel.logging_module, 
                    microskel.consul_discovery_module]
        if config('USE_DB', cast = bool):
            modules.append(microskel.db_module)
        return modules
